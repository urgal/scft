...
uses
  ...
  Datasnap.DSHTTP, Data.DB, Data.Win.ADODB;
...
uses PC2_ServerMethodsUnit, PC2_ServerContainerUnit, Web.WebReq;
...
begin
  if SameText(TagString, 'urlpath') then
    ...
    ReplaceText := PC2_ServerMethodsUnit.TServerMethods1.ClassName
